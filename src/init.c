...
/*   Updated: 2024/08/06 09:53:32 by yparthen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_variables(t_fdf *fdf)
{
	...
	fdf->move_x = WIDTH / 2 - ((fdf->borders.max.x + fdf->borders.min.x) / 2)
		* fdf->zoom;
	fdf->move_y = HEIGHT / 2 - ((fdf->borders.max.y + fdf->borders.min.y) / 2)
		* fdf->zoom;
